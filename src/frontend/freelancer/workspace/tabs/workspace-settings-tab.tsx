...
import { WorkspaceSummary, CustomField } from '@/shared/types';
import { ClientService } from '@/backend/freelancer';
      ...
      <form onSubmit={handleSaveSettings} className="space-y-6">
        ...
        <Card variant="crystal" className="p-6 border-white/10 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Input label="Workspace Logo URL" value={logoUrl} onChange={(e) => setLogoUrl(e.target.value)} placeholder="https://..." />
          </div>
        </Card>
