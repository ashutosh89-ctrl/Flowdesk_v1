...
export const OnboardingFlow: React.FC<OnboardingFlowProps> = ({ onComplete }) => {
  ...
  const [fullName, setFullName] = useState<string>(profile?.name || user?.user_metadata?.full_name || 'Alex Rivera');
  ...
  const [businessName, setBusinessName] = useState<string>(profile?.companyName || user?.user_metadata?.business_name || 'Rivera Studio');
