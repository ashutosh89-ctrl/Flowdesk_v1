        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
          <div className="space-y-2 max-w-2xl">
            ...
            <p className="text-sm text-zinc-300 leading-relaxed">
              Your centralized collaboration portal with Rivera Studio. Review deliverables, submit requested compliance assets, and track project milestones.
            </p>
          </div>
        ...
        <div className="space-y-6">
          ...
          <Card variant="crystal" className="border-blue-500/20 bg-blue-500/[0.02]">
            <CardHeader>
              ...
              <CardDescription>Documents requested by Alex Rivera</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
